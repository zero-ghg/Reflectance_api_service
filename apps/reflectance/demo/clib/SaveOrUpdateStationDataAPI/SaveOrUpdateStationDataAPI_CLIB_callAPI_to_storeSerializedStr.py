...
if __name__ == "__main__":
    ...
    # 2.4  序列化数据，字段之间用逗号（,）分隔，行之间用分号(;)分开,前面的为key要素的值，后面为value要素的值
    inString = "20160306060000,54323,2016,3,6,6,168,7,7,1,1,0.0000,-30.0000;20160326060000,54326,2016,3,26,6,48,8,8,1,1,-50.0000,-50.0000"
